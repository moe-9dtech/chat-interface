    ...
    <div className="relative inline-block text-left">
              <div>
                ...
                >
                 {currentOpt} 
                  <svg
                    className={`-mr-1 h-5 w-5 text-[#F24187] ${isActive ? 'rotate-180' : ""} duration-300 ease-in-out`}
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
                  >
                    ...
                    >
                      ...
                      currentOpt === 'Pinned Chats' && (
                        <svg width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5.40597 7.44648L11.9031 0.948608L12.9033 1.94806L5.40597 9.44539L0.907715 4.94713L1.90717 3.94768L5.40597 7.44648Z" fill="#F24187"/>
                        </svg>
                      )
                    }
                    </a>
